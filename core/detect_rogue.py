...
def analyze_network_threats(networks):
    ...
    # Try to run advanced analysis (preferred method)
    try:
        from core.advanced_detection import AdvancedThreatDetector
        
        # Create and use advanced detector - NO pre-processing
        detector = AdvancedThreatDetector()
        advanced_analyzed, advanced_rogues = detector.analyze_advanced_threats(networks)  # Use original networks, not pre-analyzed ones
